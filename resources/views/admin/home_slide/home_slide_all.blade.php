    ...
    <form method="post" action="{{route('store.profile')}}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
    <input name="home_slide" class="form-control" type="file"  id="image" value="{{ $homeslide->home_slide}}">
            </div>
        </div>
        <!-- end row -->
            ...
            <div class="col-sm-10">
                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($home_slide->home_slide))? url('upload/home_slide/'.$home_slide->home_slide):url('upload/no_image.jpg') }}" alt="Card image cap">
            </div>
        </div>
        <!-- end row -->
